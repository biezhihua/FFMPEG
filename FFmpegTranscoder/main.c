...
// open input file and initialize the related structure
...
// open output file and initialize the related structure
static int open_output_file(const char *filename) {
    ...
    for (i = 0; i < ifmt_ctx->nb_streams; i++) {
        ...
        if (!out_stream) {
            av_log(NULL, AV_LOG_ERROR, "Failed sallocating output stream\n");
            return AVERROR_UNKNOWN;
        }
...
// initialize AVFilter the related structure
...
int main() {
    ...
    char *input_file = "/Users/biezhihua/Downloads/biezhihua.mp4";
    char *output_file = "../biezhihua.flv";
